...
public class MyExpandedAdapter extends BaseExpandableListAdapter {
    ...
    public MyExpandedAdapter(Context context, List<String> group, List<List<String>> child){
                                ...
                                .setPositiveButton("添加", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        if (!et.getText().toString().equals("")) {
                                            ...
                                            folder.setName(et2.getText().toString());
                                            folder.setStatus("1");
